...
public class MultiSpinnerSearch extends AppCompatSpinner implements DialogInterface.OnCancelListener {
    ...
    public List<PlaceType> getSelectedItems() {
        List<PlaceType> selectedItems = new ArrayList<>();
        for (PlaceType item : items) {
            if (item.isSelected()) {
    ...
    public List<PlaceType> getItems() {
        return items;
    }

    public void setItems(List<PlaceType> items) {
        this.items = items;
    }

    public SpinnerListener getListener() {
        return listener;
    }
    ...
    public void setItems(List<PlaceType> items, int position, SpinnerListener listener) {
    ...
    public interface LimitExceedListener {
        void onLimitListener(PlaceType data);
    }

    public class MyAdapter extends BaseAdapter implements Filterable {

        List<PlaceType> arrayList;
        List<PlaceType> mOriginalValues;
        LayoutInflater inflater;

        public MyAdapter(Context context, List<PlaceType> arrayList) {
        ...
        public View getView(final int position, View convertView, ViewGroup parent) {
            ...
            final PlaceType data = arrayList.get(position);
        ...
        public Filter getFilter() {
            return new Filter() {
                ...
                protected void publishResults(CharSequence constraint, FilterResults results) {
                    ...
                    arrayList = (List<PlaceType>) results.values;
                    notifyDataSetChanged();
                }
                ...
                protected FilterResults performFiltering(CharSequence constraint) {
                    ...
                    List<PlaceType> FilteredArrList = new ArrayList<>();
